	...
	return (
		<div className="navbar-layout">
			<div className={state.isDark ? 'navbar navbar-dark' : 'navbar navbar-light'} >
				<ButtonGroup variant="text" aria-label="text button group" className='button-container'>
					<NavLink
						to="/"
				...
				<Switch inputProps={{'aria-label':'controlled'}} onChange={handleChange} defaultChecked/>
			</div>
		</div>
	)
}
